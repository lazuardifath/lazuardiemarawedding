<template>
	<div class="fixed bottom-[6.0rem] left-3 z-40 flex flex-col gap-y-3 md:bottom-5">
		<button class="floating-btn w-10 h-10" type="button" title="Bagikan" @click="isOpen = !isOpen">
		...
		<button class="floating-btn w-10 h-10" type="button" :title="!isFullscreen ? 'Maximize' : 'Minimize'" @click="fullscreen">
		...
		<button class="floating-btn w-10 h-10" type="button" :title="!isAudioPlay ? 'Unmute BGM' : 'Mute BGM'" @click="handleBGM">
