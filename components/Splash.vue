	...
	<div class="fixed top-0 left-0 z-50 h-screen w-screen bg-slate-800 bg-[url('/images/splash.jpg')] md:bg-[url('/images/splashcrpp.jpg')] v-lazy='imagePath' bg-cover bg-center bg-no-repeat md:bg-[50%_25%]" id="splash">
		...
		<div class="flex h-full w-full flex-col items-center justify-center gap-y-16">
			<div class="space-y-6 text-center md:space-y-14 lg:space-y-10">
				...
				<h2 class="font-body text-4xl text-yellow-300/90 md:text-7xl">Lazuardi & Emara</h2>
			...
			<p class="absolute bottom-5 max-w-xs text-center text-xs font-semibold text-gray-100 md:max-w-full">
				Copyright &copy; 2023 <a class="font-bold hover:underline" href="https://github.com/lazuardifath" target="_blank" rel="noopener noreferrer">Lazuardi Fatahilah Hamdi</a> | All Rights Reserved
			</p>
		</div>
	</div>
</template>
